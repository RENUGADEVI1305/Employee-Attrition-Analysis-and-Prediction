...
## AIM:           
1. Predict whether an employee will leave the company (attrition).    Target variable - Attrition
2. Predict the likelihood of an employee getting promoted.    Target variable - YearsSinceLastPromotion
